...
const Servicos = () => {
  ...
  const servicos = [
    ...
    },
    {
      ...
      description: 'Consultas presenciais em ambiente acolhedor e seguro, em Rio de Janeiro, RJ.',
      image: '/cindy2.avif',
    },
  ];
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <a
            href="https://wa.me/5521981679635?text=Olá! Gostaria de saber mais sobre os serviços."
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-green-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-600 transition-all transform hover:scale-105 shadow-lg"
          >
